...
* [OwnTracks Recorder](https://github.com/owntracks/recorder) - A lightweight program for storing and accessing location data published via MQTT (or HTTP) by the apps.
